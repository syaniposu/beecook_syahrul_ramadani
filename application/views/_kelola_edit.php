...
<section class="hero2 py-5 mt-0">
    <div class="container bg-transparent">
        ...
        <form method="POST" action="<?=base_url($this->uri->segment('1').'/simpan_update')?>">

            <input type="hidden" name="idne" value="<?=$datane['id']?>">
    
            <h1 class="fw-bold mb-5">Edit Resep</h1>
                    ...
                    <div class="row">
                        <div class="col-md-5 mb-4 mb-md-0 pe-0 pe-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="i1" name="nama_resep" placeholder="Nama Resep" required autocomplete="OFF" value="<?=$datane['name']?>">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="i3" name="durasi_masak" placeholder="Durasi Masak" required autocomplete="OFF" inputmode="numeric" oninput="$(this).val(this.value.replace(/[^0-9]/g, ''));"  value="<?=$datane['cooking_duration']?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-7 mb-4 mb-md-0">
                            <div class="mb-3">
                                ...
                                <textarea name="deskripsi" class="form-control" id="it1" rows="8" placeholder="Isi deskripsi singkat tentang makanan" required autocomplete="OFF"> <?=$datane['description']?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card shadow border-0">
                        ...
                        <div class="card-body p-3 p-md-5">
                            ...
                            <div class="tambah_bahan">
                                ...
                                <?
                                foreach ($datane['ingredients'] as $key => $value) {
                                    if ($key==0) {
                                        ?>
                                        <input type="text" class="form-control dbahan mb-2" name="bahan[]" placeholder="Bahan <?=$key+1?>" required autocomplete="OFF" value="<?=$value['description']?>">
                                        <?
                                    }else{
                                        ?>
                                        <input type="text" class="form-control dbahan mb-2" name="bahan[]" placeholder="Bahan <?=$key+1?>" required autocomplete="OFF" value="<?=$value['description']?>">
                    ...
                    <div class="card shadow border-0">
                        ...
                        <div class="card-body p-3 p-md-5">
                            ...
                            <div class="tambah_instruksi">
                                ...
                                <?
                                foreach (array_reverse($datane['recipes']) as $key => $value) {
                                    if ($key==0) {
                                        ?>
                                        <input type="text" class="form-control dinstruksi mb-2" name="instruksi[]" placeholder="Instruksi 1" required autocomplete="OFF" value="<?=$value['description']?>">
                                        <?
                                    }else{
                                        ?>
                                        <input type="text" class="form-control dinstruksi mb-2" name="instruksi[]" placeholder="Instruksi 1" autocomplete="OFF" value="<?=$value['description']?>">
                                        <?
                                    }
                                }
                                ?>
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(data.categories && data.categories.length > 0){
                    ...
                    $('.kategori').val('<?=$datane['category_id']?>');
